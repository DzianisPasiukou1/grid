angular.module('gridTaskApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/templates/directive-templates/chart-segment.html',
  ...
  $templateCache.put('app/templates/directive-templates/checkbox-select.html',
  ...
  $templateCache.put('app/templates/directive-templates/content-options-cards.html',
    "<div class=\"options\">\r" +
    "\n" +
  ...
  $templateCache.put('app/templates/directive-templates/content-options-d3.html',
    "<div class=\"options\">\r" +
    "\n" +
    "\t<div class=\"options__block\">\r" +
    "\n" +
  ...
  $templateCache.put('app/templates/directive-templates/content-options.html',
    "<div class=\"options\">\r" +
    "\n" +
    "\t<div class=\"options__block\">\r" +
    "\n" +
  ...
  $templateCache.put('app/templates/directive-templates/core-diagram.html',
    "<p id=\"chart\" max-heighter>\r" +
    "\n"
  );


  $templateCache.put('app/templates/directive-templates/custom-datepicker.html',
  ...
  $templateCache.put('app/templates/directive-templates/custom-grid.html',
  ...
  $templateCache.put('app/templates/directive-templates/custom-ui-grid.html',
  ...
  $templateCache.put('app/templates/directive-templates/debug.html',
    "<div class=\"debug\">\r" +
    "\n" +
  ...
  $templateCache.put('app/templates/directive-templates/dropdown.html',
  ...
  $templateCache.put('app/templates/directive-templates/edit-entity.html',
  ...
  $templateCache.put('app/templates/directive-templates/filter-list.html',
  ...
  $templateCache.put('app/templates/directive-templates/filter.html',
  ...
  $templateCache.put('app/templates/directive-templates/gr-template.html',
  ...
  $templateCache.put('app/templates/directive-templates/graphs.html',
  ...
  $templateCache.put('app/templates/directive-templates/grid-menu.html',
  ...
  $templateCache.put('app/templates/directive-templates/histogram.html',
  ...
  $templateCache.put('app/templates/directive-templates/history.html',
  ...
  $templateCache.put('app/templates/directive-templates/kx-nav-bar.html',
  ...
  $templateCache.put('app/templates/directive-templates/loading.html',
  ...
  $templateCache.put('app/templates/directive-templates/modal.html',
  ...
  $templateCache.put('app/templates/directive-templates/mouse-over.html',
  ...
  $templateCache.put('app/templates/directive-templates/page-content-cards.html',
  ...
  $templateCache.put('app/templates/directive-templates/page-content-d3.html',
    "<div class=\"page-content\">\r" +
    "\n" +
    "\t<div class=\"page-content__header\">\r" +
    "\n" +
  ...
  $templateCache.put('app/templates/directive-templates/page-content.html',
    "<div class=\"page-content\">\r" +
    "\n" +
    "\t<div class=\"page-content__header\">\r" +
    "\n" +
  ...
  $templateCache.put('app/templates/directive-templates/search.html',
    "<div class=\"search\">\r" +
    "\n" +
  ...
  $templateCache.put('app/templates/directive-templates/split-button.html',
  ...
  $templateCache.put('app/templates/directive-templates/ui-grid-menu.html',
  ...
  $templateCache.put('app/templates/directive-templates/upload.html',
    "<label>\r" +
    "\n" +
    "\t<input type=\"file\" />\r" +
    "\n" +
  ...
  $templateCache.put('app/templates/grid-templates/cell-templates/cell-without-sort.html',
  ...
  $templateCache.put('app/templates/grid-templates/cell-templates/cell.html',
  ...
  $templateCache.put('app/templates/grid-templates/cell-templates/fields/action.html',
  ...
  $templateCache.put('app/templates/grid-templates/cell-templates/fields/date.html',
  ...
  $templateCache.put('app/templates/grid-templates/cell-templates/fields/details.html',
  ...
  $templateCache.put('app/templates/grid-templates/cell-templates/fields/name.html',
  ...
  $templateCache.put('app/templates/grid-templates/cell-templates/fields/status.html',
  ...
  $templateCache.put('app/templates/grid-templates/cell-templates/fields/trend.html',
  ...
  $templateCache.put('app/templates/grid-templates/cell-templates/fields/type.html',
  ...
  $templateCache.put('app/templates/grid-templates/cell-templates/fields/value.html',
  ...
  $templateCache.put('app/templates/grid-templates/details-templates/details-example1.html',
  ...
  $templateCache.put('app/templates/grid-templates/details-templates/details-example2.html',
    "<div class=\"details-template\">\r" +
    "\n" +
  ...
  $templateCache.put('app/templates/grid-templates/details-templates/details-upload.html',
    "<div class=\"details-template\">\r" +
    "\n" +
  ...
  $templateCache.put('app/templates/grid-templates/details-templates/details.html',
  ...
  $templateCache.put('app/templates/grid-templates/dynamic-actions.html',
  ...
  $templateCache.put('app/templates/grid-templates/grid-footer.html',
  ...
  $templateCache.put('app/templates/grid-templates/row-templates/header-row.html',
  ...
  $templateCache.put('app/templates/grid-templates/row-templates/row-with-detalis.html',
  ...
  $templateCache.put('app/templates/grid-templates/row-templates/row.html',
  ...
  $templateCache.put('app/templates/ui-grid-templates/cell-templates/action.html',
  ...
  $templateCache.put('app/templates/ui-grid-templates/cell-templates/details.html',
    "<div class=\"cell-details\">\r" +
    "\n" +
  ...
  $templateCache.put('app/templates/ui-grid-templates/cell-templates/header.html',
  ...
  $templateCache.put('app/templates/ui-grid-templates/header.html',
  ...
  $templateCache.put('app/templates/ui-grid-templates/row.html',
